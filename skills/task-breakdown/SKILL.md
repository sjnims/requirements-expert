---
name: Task Breakdown
description: This skill should be used when the user asks to "create tasks", "break down story into tasks", "define tasks", "what tasks are needed", "write acceptance criteria", or when they have user stories and need to decompose them into specific, executable tasks with clear acceptance criteria that can be created as GitHub issues.
version: 0.1.0
---
...
- **`references/task-template.md`** - Complete task template with acceptance criteria formats
