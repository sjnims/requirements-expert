...
- GitHub CLI not available: Provide installation instructions
- Not authenticated: Suggest `gh auth login`
- Project doesn't exist: Suggest `/re:init`
- Operation failures: Apply standard recovery flow from shared-patterns skill

## Notes

- Use vision-discovery skill for methodology
- Keep questions conversational but focused
- Synthesize answers into coherent vision document
- Vision should be concise (500-1000 words)
- Encourage iteration and refinement
- Discovery answers preserved across retry attempts
- "Save draft" option preserves work even if GitHub is inaccessible
