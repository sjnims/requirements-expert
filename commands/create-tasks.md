---
name: create-tasks
description: Break down a user story into implementation tasks with acceptance criteria and create GitHub issues
allowed-tools: [AskUserQuestion, Bash, Read]
---

# Create Tasks

Break down a selected user story into concrete implementation tasks with clear acceptance criteria. Tasks are created as GitHub issues and automatically linked to the parent story.
...
1. **Compile Task Description:**
   Use template from task-breakdown skill's references/task-template.md:
   ```markdown
...
- Tasks are created as GitHub issues (not local files)
